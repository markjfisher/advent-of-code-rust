...
#[test]
fn reddit_path_test1() {
    let (grid, solution, total_cost) = parse(EXAMPLE3);
    let points = all_reindeer_points(solution.clone());
    let result = reindeer_points_to_string(&grid, &points);
    // println!("{}", result);
    assert_eq!(total_cost, 21148);
    assert_eq!(points.len(), 149);
    assert_eq!(result, indoc! {"\
        ███████████████████████████
        ███████████████████████  O█
        ██████████████████████  █O█
...
#[test]
fn reddit_path_test2() {
    let (grid, solution, total_cost) = parse(EXAMPLE4);
    let points = all_reindeer_points(solution.clone());
    let result = reindeer_points_to_string(&grid, &points);
    // println!("{}", result);
    assert_eq!(total_cost, 5078);
    assert_eq!(points.len(), 413);
    assert_eq!(result, indoc! {"\
        ████████████████████████████████████████████████████
        █                                      █          O█
        █OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO█          O█
        █OOOOOOOOOOOOOOOOOOOO█OOOOOOOOOOOOOOOOO█          O█
        █OOOOOOOOOOOOOOOOOOOO█OOOOOOOOOOOOOOOOO█          O█
        █OOOOOOOOOOOOOOOOOOOO█OOOOOOOOOOOOOOOOO█          O█
        █OOOOOOOOOOOOOOOOOOOO█OOOOOOOOOOOOOOOOO█          O█
        █OOOOOOOOOOOOOOOOOOOO█OOOOOOOOOOOOOOOOO█          O█
